...
/*
 * U-boot board support package for the SAMA5D3-EDS platform.
 *
...
void sama5d3_eds_nand_hw_init(void)
{
	...
	if (IS_ENABLED(CONFIG_SYS_NAND_DBW_16))
...
static void sama5d3_eds_usb_hw_init(void)
{
...
static void sama5d3_eds_mci0_hw_init(void)
{
...
#ifdef CONFIG_NAND_ATMEL
	sama5d3_eds_nand_hw_init();
#endif
#ifdef CONFIG_CMD_USB
	sama5d3_eds_usb_hw_init();
#endif
#ifdef CONFIG_GENERIC_ATMEL_MCI
	sama5d3_eds_mci0_hw_init();
#endif
	return 0;
}
